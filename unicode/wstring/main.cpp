 ...
 * В связи с тем, что в компиляторе MinGW64 для MS Windows
 * не определена локаль для std::locale,
 * то работа этой программы там не возможна
 *
...
int main()
{
    ...
    // При использовании этой функции в C++ не работает вывод в файл
