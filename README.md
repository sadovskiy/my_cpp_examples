...
//benchmark_sqrt                       |
cast/const_cast                        | Программа демонстрирует работу с привидением типа из константы в неконстанту
cast/dynamic_cast                      | Программа демонстрирует работу с привидением типа из объекта к другому объекту
cast/reinterpret_cast                  | Программа демонстрирует работу с привидением типа указателей из одного в другой
cast/static_cast                       | Программа демонстрирует работу с привидением базовых типов (замена Си стиля)
